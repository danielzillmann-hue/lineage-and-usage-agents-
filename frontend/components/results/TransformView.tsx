  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 13, color: "var(--ink-3)", lineHeight: 1.5, marginBottom: 18 }}>
          The full Dataform project (definitions, sources, operations, workflow YAML) gets
          force-pushed to the branch you specify. Use a fine-grained PAT with{" "}
          <code>contents: write</code> on the repo. Token never leaves the request.
        </p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <Field label="Commit message" value={commitMsg} onChange={setCommitMsg} />
