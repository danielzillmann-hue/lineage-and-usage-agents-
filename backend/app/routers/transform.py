...
# Generated by the Insignia migration orchestration agent.
...
class PushRequest(BaseModel):
    ...
    commit_message: str = "Generated by intelia Insignia migration agents"
    ...
    if body.as_pull_request and not pr_body:
        try:
            ...
            if results and results.summary:
                ...
                pr_body = (
                    f"_Generated by intelia Insignia migration agents._\n\n"
